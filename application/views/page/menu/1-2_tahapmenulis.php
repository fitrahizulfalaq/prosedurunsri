	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Tahap Menulis Teks Prosedur</h4>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
			<iframe src="https://drive.google.com/file/d/14kObL_uyLR10fSoYg3P1YXJ5W0-LM8_x/preview" frameborder="0" width="100%" height="700px"></iframe>
			</div>
