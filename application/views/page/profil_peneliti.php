				...
				<div class="card card-info card-outline">
					<div class="card-body box-profile">
						...
						<div class="text-justify">
							...
							<img src="<?= base_url()?>/assets/dist/img/peneliti.jpeg" alt="" width="100%">
							<p>
							Peneliti: <br>
							Nama: Sella Amalia Putri <br>
							NIM: 06021181823009
							</p>
							...
							<p><b>b.&nbsp;&nbsp; &nbsp;Evaluasi tes secara mandiri<br></b>Pelaksanaan evaluasi dilakukan secara mandiri melalui menu ujian pada setiap materi ujian kenaikan tingkat dengan memanfaatkan google form. Tes dapat dilakukan secara mandiri. Namun, peserta ujian kenaikan tingkat yang telah lolos menyelesaikan tes evaluasi di setiap materi, hanya akan menerima reward berupa poin sesuai tingkatan materi. Setelah seluruh poin terkumpul, selanjutnya peserta ujian kenaikan tingkat mendapat sertifikat kelulusan ujian kenaikan tingkat.<br><br></p> -->
						</div>
