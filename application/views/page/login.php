...
<body class="hold-transition login-page bg-blue" style="background-image: url(<?= base_url('/assets/dist/img/tiles.png')?>); background-repeat: repeat; background-attachment: fixed;">
<div class="login-box">
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body rounded-circle">
      ...
      <hr>
      <p class="text-center">Masukkan Username dan Kode Kamu</p>
      <form action="<?=site_url('auth/process')?>" method="post" id="FormLogin">
        ...
        <div class="row">          
          <div class="col-12">
            <button type="submit" name="login" class="btn btn-success btn-block">MASUK <i class="fas fa-forward"></i></button>
          </div>
        </div>
      </form>
